...
public class RajshahiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.akashahmed.sqlitelogin.activities.rajshahiadapter myadapt=new com.example.akashahmed.sqlitelogin.activities.rajshahiadapter(this,dhakaarea,areaimz);
